...
// Define image paths with fallback placeholders
const IMAGES = {
  supervisor: {
    src: '/Photos/Dr Ra\'ad Alkhateeb.jpeg',
    fallback: "https://placehold.co/200x200/3498db/ffffff?text=Dr.+Raad"
  },
  teamLeader: {
    src: '/Photos/Feras Almomani.jpeg',
    fallback: "https://placehold.co/300x300/2ecc71/ffffff?text=F"
  },
  teamMember1: {
    src: '/Photos/Rama Almomani.jpeg',
    fallback: "https://placehold.co/300x300/2ecc71/ffffff?text=R"
  },
  teamMember2: {
    src: '/Photos/Tasneem Alomari.jpeg',
    fallback: "https://placehold.co/300x300/2ecc71/ffffff?text=T"
  },
  teamMember3: {
    src: '/Photos/Raghad Allahham.jpeg',
    fallback: "https://placehold.co/300x300/2ecc71/ffffff?text=R"
  }
};
      ...
      <section id="supervisor" className="supervisor-section" ref={supervisorRef}>
        <div className="container">
          ...
          <div className="supervisor-card">
            <div className="supervisor-img-wrapper">
              <img 
                src={IMAGES.supervisor.src}
                alt="Dr. Raad Al-Khatib" 
                className="supervisor-img"
                onError={(e) => handleImageError(e, IMAGES.supervisor.fallback)}
              />
            </div>
            <h3 className="supervisor-name">Dr.  Ra'ed M Al-Khatib</h3>
          ...
          <div className="team-grid">
            ...
            <div className="team-card">
              <div className="team-img-container">
                <img 
                  src={IMAGES.teamLeader.src}
                  alt="Feras Al-Momani" 
                  className="team-img"
                  onError={(e) => handleImageError(e, IMAGES.teamLeader.fallback)}
                />
              </div>
            ...
            <div className="team-card">
              <div className="team-img-container">
                <img 
                  src={IMAGES.teamMember1.src}
                  alt="Rama Al-Momani" 
                  className="team-img"
                  onError={(e) => handleImageError(e, IMAGES.teamMember1.fallback)}
                />
              </div>
              <div className="team-info">
                <div>
            ...
            {/* Team Member 2 - Tasneem */}
            <div className="team-card">
              <div className="team-img-container">
                <img 
                  src={IMAGES.teamMember2.src}
                  alt="Tasneem Al-Omari" 
                  className="team-img"
                  onError={(e) => handleImageError(e, IMAGES.teamMember2.fallback)}
                />
              </div>
              <div className="team-info">
                <div>
            ...
            {/* Team Member 3 - Raghad */}
            <div className="team-card">
              <div className="team-img-container">
                <img 
                  src={IMAGES.teamMember3.src}
                  alt="Raghad Al-Lahham" 
                  className="team-img"
                  onError={(e) => handleImageError(e, IMAGES.teamMember3.fallback)}
                />
              </div>
              <div className="team-info">
                <div>
